--  Sieve of Atkin — Ada 2023 educational package.
--  Modern quadratic sieve for primes up to N (Natural / Positive).
--  Primary source:
--  https://en.wikipedia.org/wiki/Sieve_of_Atkin
--  Sibling: Ada-Sieve-Of-Eratosthenes. Next: Miller–Rabin (sheet typo Miler-Rabin).
...
is
   ...
   --  Index = candidate; True means prime after sieving.
   ...
   --  Is_Prime (0 .. N). Indices 0 and 1 are False; 2 and 3 hardcoded
   --  prime when in range; n ≥ 5 use Atkin quadratic toggles + square
   --  free culling. Raises Invalid_Argument if N < 2 or N > Max_N.
